    ...
    <SafeAreaView style={styles.container}>
        <ScrollView>  
            ...
            <SelectList 
                      ...
                      boxStyles={{fontSize:40,borderColor:"white",backgroundColor:"#F5F5F5",width:"90%",marginLeft:'auto',marginRight:'auto',marginTop:"5%"}} //override default styles
                      // defaultOption={{ key:'1', value:'Jammu & Kashmir' }}   //default selected option
                      
              />

          <TouchableOpacity style = {{ width : "88%", height:50, backgroundColor:"#363488",borderRadius:10,marginTop:"5%",marginLeft:"6%"}}>
            <View>
